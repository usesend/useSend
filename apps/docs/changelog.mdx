...
### Webhooks
You can now receive real-time notifications for email events via webhooks. Configure webhook endpoints to track deliveries, bounces, complaints, and more.

### Python SDK
Official Python SDK now available with built-in webhook verification and event handling support.
...
Configure retention periods for your emails. Automatically clean up old emails based on your preferred schedule to keep your data lean.
...
- Bulk upload contacts with improved performance.
- Email usage alerts notify you when approaching plan limits.
- Docker image version now displayed in the sidebar.
- Duplicate notification emails prevented via atomic locking.
