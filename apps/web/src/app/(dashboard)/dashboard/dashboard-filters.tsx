...
import { Select, SelectContent, SelectItem, SelectTrigger } from "@usesend/ui/src/select";
...
export default function DashboardFilters({ days, setDays, domain, setDomain }: DashboardFiltersProps) {
